...
AssetCatalog.Models = {
    ...
    Hub = {
        Ground = {
            name = "HubGround_Custom01",
            offset = Vector3.new(0, 0, 0),
            rotation_degrees = Vector3.new(0, 0, 0),
            scale = 1.0,
            static = true,
        },
        DecorSet = nil,
...
AssetCatalog.Models = {
    ...
    WarnOnMissing = true,
    Hub = {
        -- Full replacement of primitive baseplate when set.
        -- Tune offset/rotation/scale if needed.
        Ground = {
            name = "HubGround_Custom01",
            offset = Vector3.new(0, 0, 0),
            rotation_degrees = Vector3.new(0, 0, 0),
...
AssetCatalog.Models = {
    ...
    WarnOnMissing = true,
    Hub = {
        -- Set this to replace the primitive baseplate/ground.
        Ground = nil,
        DecorSet = nil,
        RollStation = nil,
        InventoryPedestal = nil,
